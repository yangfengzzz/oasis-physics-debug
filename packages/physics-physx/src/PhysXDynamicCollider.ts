...
export class PhysXDynamicCollider extends PhysXCollider implements IDynamicCollider {
  ...
  set collisionDetectionMode(value: CollisionDetectionMode) {
    ...
    switch (value) {
      case CollisionDetectionMode.Continuous:
        this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eENABLE_CCD, true);
        break;
      case CollisionDetectionMode.ContinuousDynamic:
        this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eENABLE_CCD_FRICTION, true);
        break;
      case CollisionDetectionMode.ContinuousSpeculative:
        this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eENABLE_SPECULATIVE_CCD, true);
        break;
      case CollisionDetectionMode.Discrete:
        this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eENABLE_CCD, false);
        this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eENABLE_CCD_FRICTION, false);
        this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eENABLE_SPECULATIVE_CCD, false);
        break;
    }
  }
  ...
  set isKinematic(value: boolean) {
    ...
    if (value) {
      this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eKINEMATIC, true);
    } else {
      this._pxActor.setRigidBodyFlag(PhysXPhysicsDebug._physX.PxRigidBodyFlag.eKINEMATIC, false);
    }
  }
  ...
  constructor(position: Vector3, rotation: Quaternion) {
    ...
    this._pxActor = PhysXPhysicsDebug._pxPhysics.createRigidDynamic(transform);
  }
  ...
  setConstraints(flag: DynamicColliderConstraints, value: boolean) {
    ...
    switch (flag) {
      case DynamicColliderConstraints.FreezePositionX:
        this._pxActor.setRigidDynamicLockFlag(PhysXPhysicsDebug._physX.PxRigidDynamicLockFlag.eLOCK_LINEAR_X, value);
        break;
      case DynamicColliderConstraints.FreezePositionY:
        this._pxActor.setRigidDynamicLockFlag(PhysXPhysicsDebug._physX.PxRigidDynamicLockFlag.eLOCK_LINEAR_Y, value);
        break;
      case DynamicColliderConstraints.FreezePositionZ:
        this._pxActor.setRigidDynamicLockFlag(PhysXPhysicsDebug._physX.PxRigidDynamicLockFlag.eLOCK_LINEAR_Y, value);
        break;
      case DynamicColliderConstraints.FreezeRotationX:
        this._pxActor.setRigidDynamicLockFlag(PhysXPhysicsDebug._physX.PxRigidDynamicLockFlag.eLOCK_ANGULAR_X, value);
        break;
      case DynamicColliderConstraints.FreezeRotationY:
        this._pxActor.setRigidDynamicLockFlag(PhysXPhysicsDebug._physX.PxRigidDynamicLockFlag.eLOCK_ANGULAR_Y, value);
        break;
      case DynamicColliderConstraints.FreezeRotationZ:
        this._pxActor.setRigidDynamicLockFlag(PhysXPhysicsDebug._physX.PxRigidDynamicLockFlag.eLOCK_ANGULAR_Z, value);
        break;
